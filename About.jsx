...
<div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
  ...
  <div class="offcanvas-body">
    <p>Try scrolling the rest of the page to see this option in action.</p>
          ...
          <span className="" style={{ marginLeft: "520px" ,paddingBottom:"100px"}}>
        ...
        <div className="container py-4  px-4  ">
          ...
          <p className="col-6"style={{color:"#9F9F9F",marginLeft:"190px",fontSize:"13px"}}>
              Embodying the raw, wayward spirit of rock ‘n’ roll, the Kilburn
              portable active stereo speaker takes the unmistakable look and
              sound of Marshall, unplugs the chords, and takes the show on the
              road.
            </p>
            <p style={{color:"#9F9F9F",marginLeft:"195px",fontSize:"13px"}} className="col-7">
...
<img src="Images/des1.png" alt="" className="col-med-3 m-1" style={{width:"350px",backgroundColor:"#F9F1E7"}}/>
<img src="Images/des2.png" alt="" className="col-med-3 m-2" style={{width:"350px",backgroundColor:"#F9F1E7"}}/>
...
<h4 className="text-center">Related products</h4>
        ...
        <div className="row col-md-12 py-4 "  style={{marginLeft:"100px"}}>
        <div
          className=" col-2 "
        ...
        <Link to={"/Shop"}>
              <button
                ...
                style={{
                  ...
                  position: "absolute",
                  marginLeft: "25%",
                  color: "rgba(184, 142, 47, 1)",marginTop:"30px"
                }}
              >
                show more
              </button>
